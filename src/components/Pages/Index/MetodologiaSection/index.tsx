        ...
        <ContentBlock>
          ...
          <Content>
            <p>
              ...
              com uma amostragem de mais de 400 perfis do Instagram de artistas
              e curadores negros e/ou indígenas brasileiros e mais de 30 perfis
              de instituições de arte brasileiras coletados entre os meses de
            ...
            <p>
              ...
              Lorraine Mendes, tendo como parâmetro as categorias Artista e Arte
              do próprio Instagram e alguns termos seletores, como as palavras
              negro e indígena, por exemplo. Porém, isso não foi possível, já
              que essa rede social não disponibiliza essas categorias de forma
              livre em seu código, limitando, com isso, as possibilidades e
              escopo da base de dados do projeto. Um ponto importante a
              ressaltar é que o Instagram cria todo tipo de dificuldade possível
              para o acesso a seus dados. A partir disso, tivemos que recorrer à
              criação de uma base de dados manual, realizada por uma
              força-tarefa formada por todas as integrantes da equipe de
              desenvolvimento do projeto {"<ATER>"}.
            </p>
            <br />
            <p>
              Essa base de dados manual teve como pontos de partida uma
              curadoria prévia de Larissa Macêdo, que acompanha desde 2018 a
              ...
              que tivessem interesse em contribuir com a base de dados do
              projeto. Essa chamada ficará aberta em fluxo contínuo para todos
              que quiserem colaborar e participar de outras etapas da série{" "}
              {"<ATER>"}.
            </p>
            <br />
            <p>
              ...
              idealizadores do projeto, considerando uma amostragem baseada na
              localidade das instituições, com o intuito de ter uma
              representação de todas as regiões do Brasil, no porte e na
              relevância dessas instituições para o sistema da arte nacional.
            </p>
            <br />
            <p>
              As informações que fazem parte da base de dados do projeto são
              todas aquelas que conseguimos extrair dos perfis do Instagram de
              forma manual e que, portanto, são de conhecimento de todos que
              fazem parte dessa rede social. Devido às restrições da plataforma,
              não foi possível incluir as informações relativas às postagens.
              Portanto, a base de dados é composta pelas seguintes informações:
            </p>
            <br />
            <p>
              Perfil do Instagram (@); link do perfil no Instagram; atuação;
              nome; categoria; site; opções de contato; se o perfil é verificado
              ou não; se o perfil é público ou privado; quantidade publicações;
              quantidade de seguidores; quantidade de perfis que segue; e todas
              as informações que aparecem no campo de texto da bio, como, por
              exemplo: país, região (residência), estado (residência), cidade
              (residência) etc.
            </p>
            <br />
            <p>
              Os dados referentes a raça, gênero, atuação (artista, curador
              etc.), tipo de perfil (coletivo ou individual), região, estado e
              cidade de residência só estão disponíveis no caso de pessoas que
              forneceram essas informações no campo “bio” do perfil no Instagram
              ou que contribuíram com a chamada pública de mapeamento do
              projeto.
            </p>
            <br />
            <p>
